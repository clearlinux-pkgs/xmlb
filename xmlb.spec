...
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.11/libxmlb-0.3.11.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.11
cd %{_builddir}/libxmlb-0.3.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677004836
