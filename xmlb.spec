...
Version  : 0.1.14
Release  : 4
URL      : https://github.com/hughsie/libxmlb/archive/0.1.14/libxmlb-0.1.14.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.1.14/libxmlb-0.1.14.tar.gz
...
%prep
%setup -q -n libxmlb-0.1.14
cd %{_builddir}/libxmlb-0.1.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579664623
...
cp %{_builddir}/libxmlb-0.1.14/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
