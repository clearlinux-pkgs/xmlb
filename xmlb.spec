...
Version  : 0.3.8
Release  : 14
URL      : https://github.com/hughsie/libxmlb/archive/0.3.8/libxmlb-0.3.8.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.8/libxmlb-0.3.8.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.8
cd %{_builddir}/libxmlb-0.3.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647965742
...
cp %{_builddir}/libxmlb-0.3.8/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
