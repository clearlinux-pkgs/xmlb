...
Version  : 0.3.3
Release  : 11
URL      : https://github.com/hughsie/libxmlb/archive/0.3.3/libxmlb-0.3.3.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.3/libxmlb-0.3.3.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.3
cd %{_builddir}/libxmlb-0.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633567955
...
cp %{_builddir}/libxmlb-0.3.3/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
