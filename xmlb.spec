...
Version  : 0.3.7
Release  : 13
URL      : https://github.com/hughsie/libxmlb/archive/0.3.7/libxmlb-0.3.7.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.7/libxmlb-0.3.7.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.7
cd %{_builddir}/libxmlb-0.3.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645034375
...
cp %{_builddir}/libxmlb-0.3.7/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
