...
Version  : 0.3.19
Release  : 25
URL      : https://github.com/hughsie/libxmlb/archive/0.3.19/libxmlb-0.3.19.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.19/libxmlb-0.3.19.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.19
cd %{_builddir}/libxmlb-0.3.19
pushd ..
cp -a libxmlb-0.3.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713889951
