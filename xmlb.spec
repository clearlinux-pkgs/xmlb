...
Version  : 0.3.22
Release  : 28
URL      : https://github.com/hughsie/libxmlb/archive/0.3.22/libxmlb-0.3.22.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.22/libxmlb-0.3.22.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.22
cd %{_builddir}/libxmlb-0.3.22
pushd ..
cp -a libxmlb-0.3.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741818109
