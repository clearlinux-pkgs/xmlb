...
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.15/libxmlb-0.3.15.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.15
cd %{_builddir}/libxmlb-0.3.15
pushd ..
cp -a libxmlb-0.3.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704214323
