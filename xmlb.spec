...
Version  : 0.3.0
Release  : 8
URL      : https://github.com/hughsie/libxmlb/archive/0.3.0/libxmlb-0.3.0.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.3.0/libxmlb-0.3.0.tar.gz
...
%prep
%setup -q -n libxmlb-0.3.0
cd %{_builddir}/libxmlb-0.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615590109
...
cp %{_builddir}/libxmlb-0.3.0/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
