...
Version  : 0.1.13
Release  : 3
URL      : https://github.com/hughsie/libxmlb/archive/0.1.13/libxmlb-0.1.13.tar.gz
Source0  : https://github.com/hughsie/libxmlb/archive/0.1.13/libxmlb-0.1.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571848923
...
cp %{_builddir}/libxmlb-0.1.13/LICENSE %{buildroot}/usr/share/package-licenses/xmlb/b386b371ce94933e63ced1052aa72a60da5485ff
